...
class MainScene extends Scene {
    ...
    onAdded() {
        ...
        e2.addComponent(new CircleSatCollider({layer: Layers.Guy, radius: 10}))
        ...
        const groundCheck = groundChild.addComponent(new CircleSatCollider({
            layer: Layers.WallCheck, radius: 12,
        }));
